...
class StandardRoIHead(BaseRoIHead):
    ...
    def loss(self, x: Tuple[Tensor], rpn_results_list: InstanceList,
        ...
        return losses, bbox_results['det_result']
    ...
    def bbox_loss(self, x: Tuple[Tensor],
                  sampling_results: List[SamplingResult], batch_data_samples) -> dict:
        ...
        bbox_loss_and_target = self.bbox_head.loss_and_predict(
        ...
        bbox_results.update(loss_bbox=bbox_loss_and_target['loss_bbox'], det_result=bbox_loss_and_target['det_result'])
        return bbox_results
