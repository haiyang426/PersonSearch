...
class BBoxHead(BaseModule):
    ...
    def loss_and_predict(self,
        ...
        result = self.predict_by_feat(list(rois.split(128)), list(cls_score.split(128)), list(bbox_pred.split(128)), batch_img_metas)
        return dict(loss_bbox=losses, bbox_targets=cls_reg_targets, det_result=result)
