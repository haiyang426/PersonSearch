...
def multiclass_embedding_nms(
    ...
    if not torch.onnx.is_in_onnx_export():
        ...
        bboxes, scores, labels, ids = bboxes[inds], scores[inds], labels[inds], multi_ids[inds]
    else:
    ...
    if return_inds:
        ...
        return dets, labels[keep], ids[keep]
